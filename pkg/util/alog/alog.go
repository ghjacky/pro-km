...
// Package alog implements logging analogous to the Google-internal C++ INFO/ERROR/V setup.
...
func (l *loggingT) exit(err error) {
	_, _ = fmt.Fprintf(os.Stderr, "log: exiting because of error: %s\n", err)
...
// The startup argument indicates whether this is the initial startup of alog.
