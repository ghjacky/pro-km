...
// copy from https://github.com/TimeBye/go-harbor
...
// Client harbor client to connect
type Client struct {
...
// SearchRepository result of search
...
func (c *Client) Search(opt *SearchOption) (Search, *gorequest.Response, []error) {
	var search Search
