...
func (p *Paginator) Page() int {
	...
	p.page, _ = strconv.Atoi(p.Request.Form.Get("current_page"))
...
func SetPaginator(req *restful.Request, per int, nums int64) (paginator *Paginator) {
	paginator = NewPaginator(req.Request, per, nums)
